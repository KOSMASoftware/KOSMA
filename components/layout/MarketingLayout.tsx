  ...
  return (
    <PulsingDotsBackground>
      <div className="min-h-screen flex flex-col font-sans">
        {/* HEADER */}
        <nav className="bg-white/80 backdrop-blur-sm py-4 px-6 md:px-12 flex items-center justify-between sticky top-0 z-50 shadow-sm border-b border-gray-100 h-[72px]">
